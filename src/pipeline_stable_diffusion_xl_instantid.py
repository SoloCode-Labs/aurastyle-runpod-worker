...
class StableDiffusionXLInstantIDPipeline(StableDiffusionXLControlNetPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # NOTE: Use keyword arguments to avoid positional mismatch with diffusers 0.28.2
        # parent check_inputs which includes ip_adapter_image / ip_adapter_image_embeds params
        # that this InstantID pipeline does not pass, shifting all subsequent positional args.
        self.check_inputs(
            prompt=prompt,
            prompt_2=prompt_2,
            image=image,
